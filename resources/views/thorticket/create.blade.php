...
<div class="card shadow" >
    <div class="card-header border-0">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="mb-0">Nuevo Acertijo Ticket</h3>
            </div>
            ...
            <div class="row"> 
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea name="t_pregunta1"  class="form-control" rows="10" value="{{old('t_pregunta1')}}" required></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group" >
                        <h5>PREGUNTA N°2</h5>
                        <textarea name="t_pregunta2"  class="form-control" rows="10" value="{{old('t_pregunta2')}}" required></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group" >
                        <h5>PREGUNTA N°3</h5>
                        <textarea name="t_pregunta3"  class="form-control" rows="10" value="{{old('t_pregunta3')}}" required></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="t_llave1" class="form-control" value="{{old('t_llave1')}}"  onkeypress="javascript: return ValidarNumero(event,this)" onkeyup="mayus(this)"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <h5 for="">LLAVE N°2 <em>(Poner en mayúscula y sin signos)</em></h5>
                      <input type="text" name="t_llave2" class="form-control"  value="{{old('t_llave2')}}" onkeypress="javascript: return ValidarNumero(event,this)" onkeyup="mayus(this)"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <h5 for="">LLAVE N°3 <em>(Poner en mayúscula y sin signos)</em> </h5>
                      <input type="text" name="t_llave3" class="form-control" value="{{old('t_llave3')}}" onkeypress="javascript: return ValidarNumero(event,this)" onkeyup="mayus(this)"/>
                    </div>
                </div>
            </div>
            <div class="col text-right">
